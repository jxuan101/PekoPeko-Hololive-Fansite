...
const hololiveid_assets = [];
const holostar_assets = [];

// Hololive JP ************************************

// Zero Generation
hololivejp_assets.push(AZKi);
hololivejp_assets.push(Hoshimachi_Suisei);
hololivejp_assets.push(Roboco);
hololivejp_assets.push(Sakura_Miko);
hololivejp_assets.push(Tokino_Sora);

// First Generation
hololivejp_assets.push(Akai_Haato);
hololivejp_assets.push(Aki_Rosenthal);
hololivejp_assets.push(Natsuiro_Matsuri);
hololivejp_assets.push(Yozora_Mel);

// Second Generation
hololivejp_assets.push(Minato_Aqua);
hololivejp_assets.push(Murasaki_Shion);
hololivejp_assets.push(Nakiri_Ayame);
hololivejp_assets.push(Oozora_Subaru);
hololivejp_assets.push(Yuzuki_Choco);

// Hololive Gamers
hololivejp_assets.push(Inugami_Korone);
hololivejp_assets.push(Nekomata_Okayu);
hololivejp_assets.push(Ookami_Mio);
hololivejp_assets.push(Shirakami_Fubuki);

// Third Generation
hololivejp_assets.push(Houshou_Marine);
hololivejp_assets.push(Shiranui_Flare);
hololivejp_assets.push(Shirogane_Noel);
hololivejp_assets.push(Uruha_Rushia);
hololivejp_assets.push(Usada_Pekora);

// Fourth Generation
hololivejp_assets.push(Amane_Kanata);
hololivejp_assets.push(Himemori_Luna);
hololivejp_assets.push(Kiryu_Coco);
hololivejp_assets.push(Tokoyami_Towa);
hololivejp_assets.push(Tsunomaki_Watame);

// Hololive Indonesia ************************************
hololiveid_assets.push(Airani_Iofifteen);
hololiveid_assets.push(Ayunda_Risu);
hololiveid_assets.push(Hoshinova_Moona);

// Holostar ************************************
holostar_assets.push(Aragami_Oga);
holostar_assets.push(Arurandeisu);
holostar_assets.push(Astel_Leda);
holostar_assets.push(Hanasaki_Miyabi);
holostar_assets.push(Kagami_Kira);
holostar_assets.push(Kageyama_Shien);
holostar_assets.push(Kanade_Izuru);
holostar_assets.push(Kishido_Temma);
holostar_assets.push(Rikka);
holostar_assets.push(Tsukishita_Kaoru);
holostar_assets.push(Yukoku_Roberu);

const getHololiveJPAssets = () => {
    return hololivejp_assets;
};

const getHololiveIDAssets = () => {
    return hololiveid_assets;
};

const getHolostarAssets = () => {
    return holostar_assets;
}

exports.getHololiveJPAssets = getHololiveJPAssets;
exports.getHololiveIDAssets = getHololiveIDAssets;
exports.getHolostarAssets = getHolostarAssets;